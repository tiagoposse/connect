...
const (
	...
	AdminAuditRead        authz.Scope = "admin.audit.readonly"
	AdminSSOAll           authz.Scope = "admin.sso.*"
	AdminSSOConfigure     authz.Scope = "admin.sso.configure"
	AdminSSOSync          authz.Scope = "admin.sso.sync"
