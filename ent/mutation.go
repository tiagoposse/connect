...
func (m *ApiKeyMutation) SetScopes(a authorization.Scopes) {
	m.scopes = &a
}

// Scopes returns the value of the "scopes" field in the mutation.
func (m *ApiKeyMutation) Scopes() (r authorization.Scopes, exists bool) {
	v := m.scopes
	if v == nil {
		return
	}
...
// If the ApiKey object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *ApiKeyMutation) OldScopes(ctx context.Context) (v authorization.Scopes, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *ApiKeyMutation) SetField(name string, value ent.Value) error {
	...
	case apikey.FieldKey:
		...
		return nil
	case apikey.FieldScopes:
		v, ok := value.(authorization.Scopes)
		if !ok {
			return fmt.Errorf("unexpected type %T for field %s", value, name)
		}
		m.SetScopes(v)
...
// SetScopes sets the "scopes" field.
func (m *GroupMutation) SetScopes(a authorization.Scopes) {
	m.scopes = &a
}

// Scopes returns the value of the "scopes" field in the mutation.
func (m *GroupMutation) Scopes() (r authorization.Scopes, exists bool) {
	v := m.scopes
	if v == nil {
		return
	}
...
// If the Group object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *GroupMutation) OldScopes(ctx context.Context) (v authorization.Scopes, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldScopes is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
