...
var jsonFieldsNameOfAuditList = [5]string{
	0: "id",
	1: "action",
	2: "author",
	3: "timestamp",
...
// Encode implements json.Marshaler.
func (s *AuditListUser) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *AuditListUser) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
...
var jsonFieldsNameOfAuditListUser = [9]string{
	0: "id",
	1: "email",
	2: "firstname",
	3: "lastname",
...
// Decode decodes AuditListUser from json.
func (s *AuditListUser) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AuditListUser to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AuditListUser")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAuditListUser) {
					name = jsonFieldsNameOfAuditListUser[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *AuditListUser) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *AuditListUser) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfAuditRead = [5]string{
	0: "id",
	1: "action",
	2: "author",
	3: "timestamp",
...
// Encode implements json.Marshaler.
func (s *AuditReadUser) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *AuditReadUser) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("id")
		e.Str(s.ID)
	}
...
var jsonFieldsNameOfAuditReadUser = [9]string{
	0: "id",
	1: "email",
	2: "firstname",
	3: "lastname",
...
// Decode decodes AuditReadUser from json.
func (s *AuditReadUser) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode AuditReadUser to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode AuditReadUser")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfAuditReadUser) {
					name = jsonFieldsNameOfAuditReadUser[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *AuditReadUser) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *AuditReadUser) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
		...
		case "allowed_ips":
			...
			if err := func() error {
				...
				if err := d.Arr(func(d *jx.Decoder) error {
					...
					s.AllowedIps = append(s.AllowedIps, elem)
					return nil
				}); err != nil {
					return err
				}
...
var jsonFieldsNameOfCreateGroupReqRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfGroupCreateRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfGroupListRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfGroupReadRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfGroupUpdateRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfUpdateDeviceReq = [8]string{
	0: "name",
	1: "description",
	2: "type",
	3: "dns",
...
var jsonFieldsNameOfUpdateGroupReqRulesItem = [2]string{
	0: "target",
	1: "type",
}
...
var jsonFieldsNameOfUserAuditList = [4]string{
	0: "id",
	1: "action",
	2: "author",
	3: "timestamp",
...
var jsonFieldsNameOfUserGroupReadRulesItem = [2]string{
	0: "target",
	1: "type",
}
