...
func NewAuditList(e *ent.Audit) *AuditList {
	...
	ret.User = NewAuditListUser(e.Edges.User).Elem()
	return &ret
}
...
func NewAuditListUser(e *ent.User) *AuditListUser {
	if e == nil {
		return nil
	}
	var ret AuditListUser
	ret.ID = e.ID
	ret.Email = e.Email
	ret.Firstname = e.Firstname
	ret.Lastname = e.Lastname
...
func NewAuditListUsers(es []*ent.User) []AuditListUser {
	if len(es) == 0 {
		return nil
	}
	r := make([]AuditListUser, len(es))
	for i, e := range es {
		r[i] = NewAuditListUser(e).Elem()
	}
	return r
}

func (u *AuditListUser) Elem() AuditListUser {
	if u == nil {
		return AuditListUser{}
	}
	return *u
}
...
func NewAuditRead(e *ent.Audit) *AuditRead {
	...
	ret.Author = e.Author
	ret.Timestamp = e.Timestamp
	ret.User = NewAuditReadUser(e.Edges.User).Elem()
	return &ret
}
...
func NewAuditReadUser(e *ent.User) *AuditReadUser {
	if e == nil {
		return nil
	}
	var ret AuditReadUser
	ret.ID = e.ID
	ret.Email = e.Email
	ret.Firstname = e.Firstname
	ret.Lastname = e.Lastname
...
func NewAuditReadUsers(es []*ent.User) []AuditReadUser {
	if len(es) == 0 {
		return nil
	}
	r := make([]AuditReadUser, len(es))
	for i, e := range es {
		r[i] = NewAuditReadUser(e).Elem()
	}
	return r
}

func (u *AuditReadUser) Elem() AuditReadUser {
	if u == nil {
		return AuditReadUser{}
	}
	return *u
}
