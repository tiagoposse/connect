...
func (s *AuditList) GetUser() AuditListUser {
	return s.User
}
...
func (s *AuditList) SetUser(val AuditListUser) {
	s.User = val
}

// Ref: #/components/schemas/AuditList_User
type AuditListUser struct {
	ID             string    `json:"id"`
	Email          string    `json:"email"`
	Firstname      string    `json:"firstname"`
	Lastname       string    `json:"lastname"`
...
// GetID returns the value of ID.
func (s *AuditListUser) GetID() string {
	return s.ID
}

// GetEmail returns the value of Email.
func (s *AuditListUser) GetEmail() string {
	return s.Email
}

// GetFirstname returns the value of Firstname.
func (s *AuditListUser) GetFirstname() string {
	return s.Firstname
}

// GetLastname returns the value of Lastname.
func (s *AuditListUser) GetLastname() string {
	return s.Lastname
}

// GetProvider returns the value of Provider.
func (s *AuditListUser) GetProvider() string {
	return s.Provider
}

// GetPhotoURL returns the value of PhotoURL.
func (s *AuditListUser) GetPhotoURL() OptString {
	return s.PhotoURL
}

// GetDisabled returns the value of Disabled.
func (s *AuditListUser) GetDisabled() bool {
	return s.Disabled
}

// GetDisabledReason returns the value of DisabledReason.
func (s *AuditListUser) GetDisabledReason() OptString {
	return s.DisabledReason
}

// GetGroupID returns the value of GroupID.
func (s *AuditListUser) GetGroupID() string {
	return s.GroupID
}

// SetID sets the value of ID.
func (s *AuditListUser) SetID(val string) {
	s.ID = val
}

// SetEmail sets the value of Email.
func (s *AuditListUser) SetEmail(val string) {
	s.Email = val
}

// SetFirstname sets the value of Firstname.
func (s *AuditListUser) SetFirstname(val string) {
	s.Firstname = val
}

// SetLastname sets the value of Lastname.
func (s *AuditListUser) SetLastname(val string) {
	s.Lastname = val
}

// SetProvider sets the value of Provider.
func (s *AuditListUser) SetProvider(val string) {
	s.Provider = val
}

// SetPhotoURL sets the value of PhotoURL.
func (s *AuditListUser) SetPhotoURL(val OptString) {
	s.PhotoURL = val
}

// SetDisabled sets the value of Disabled.
func (s *AuditListUser) SetDisabled(val bool) {
	s.Disabled = val
}

// SetDisabledReason sets the value of DisabledReason.
func (s *AuditListUser) SetDisabledReason(val OptString) {
	s.DisabledReason = val
}

// SetGroupID sets the value of GroupID.
func (s *AuditListUser) SetGroupID(val string) {
	s.GroupID = val
}
...
// GetUser returns the value of User.
func (s *AuditRead) GetUser() AuditReadUser {
	return s.User
}
...
// SetUser sets the value of User.
func (s *AuditRead) SetUser(val AuditReadUser) {
	s.User = val
}

func (*AuditRead) readAuditRes() {}

// Ref: #/components/schemas/AuditRead_User
type AuditReadUser struct {
	ID             string    `json:"id"`
	Email          string    `json:"email"`
	Firstname      string    `json:"firstname"`
	Lastname       string    `json:"lastname"`
...
// GetID returns the value of ID.
func (s *AuditReadUser) GetID() string {
	return s.ID
}

// GetEmail returns the value of Email.
func (s *AuditReadUser) GetEmail() string {
	return s.Email
}

// GetFirstname returns the value of Firstname.
func (s *AuditReadUser) GetFirstname() string {
	return s.Firstname
}

// GetLastname returns the value of Lastname.
func (s *AuditReadUser) GetLastname() string {
	return s.Lastname
}

// GetProvider returns the value of Provider.
func (s *AuditReadUser) GetProvider() string {
	return s.Provider
}

// GetPhotoURL returns the value of PhotoURL.
func (s *AuditReadUser) GetPhotoURL() OptString {
	return s.PhotoURL
}

// GetDisabled returns the value of Disabled.
func (s *AuditReadUser) GetDisabled() bool {
	return s.Disabled
}

// GetDisabledReason returns the value of DisabledReason.
func (s *AuditReadUser) GetDisabledReason() OptString {
	return s.DisabledReason
}

// GetGroupID returns the value of GroupID.
func (s *AuditReadUser) GetGroupID() string {
	return s.GroupID
}

// SetID sets the value of ID.
func (s *AuditReadUser) SetID(val string) {
	s.ID = val
}

// SetEmail sets the value of Email.
func (s *AuditReadUser) SetEmail(val string) {
	s.Email = val
}

// SetFirstname sets the value of Firstname.
func (s *AuditReadUser) SetFirstname(val string) {
	s.Firstname = val
}

// SetLastname sets the value of Lastname.
func (s *AuditReadUser) SetLastname(val string) {
	s.Lastname = val
}

// SetProvider sets the value of Provider.
func (s *AuditReadUser) SetProvider(val string) {
	s.Provider = val
}

// SetPhotoURL sets the value of PhotoURL.
func (s *AuditReadUser) SetPhotoURL(val OptString) {
	s.PhotoURL = val
}

// SetDisabled sets the value of Disabled.
func (s *AuditReadUser) SetDisabled(val bool) {
	s.Disabled = val
}

// SetDisabledReason sets the value of DisabledReason.
func (s *AuditReadUser) SetDisabledReason(val OptString) {
	s.DisabledReason = val
}

// SetGroupID sets the value of GroupID.
func (s *AuditReadUser) SetGroupID(val string) {
	s.GroupID = val
}
...
// GetTimestamp returns the value of Timestamp.
func (s *UserAuditList) GetTimestamp() time.Time {
	return s.Timestamp
}
...
// SetTimestamp sets the value of Timestamp.
func (s *UserAuditList) SetTimestamp(val time.Time) {
	s.Timestamp = val
}
