...
func (gu *GroupUpdate) SetScopes(a authorization.Scopes) *GroupUpdate {
	gu.mutation.SetScopes(a)
	return gu
}
...
// SetScopes sets the "scopes" field.
func (guo *GroupUpdateOne) SetScopes(a authorization.Scopes) *GroupUpdateOne {
	guo.mutation.SetScopes(a)
	return guo
}
